    ...
    $.fn.goFaq = function(options) {
        ...
        return this.each(function(i) {
            ...
            if (options.question.length > 0) {
                $('input[name="search"]').val(options.question).keyup();
            }
        ...
        function generateEmptySearch () {
            ...
            return $empty.html('<p style="text-align: center;">Desculpe, a informação que você deseja não foi encontrado...</p>');
        }
        ...
        function generateSearchForm () {
            ...
            var $input = $('<input>', {
                'type': 'text',
                'name': 'search',
                'placeholder': 'Informe aqui o assunto que você deseja saber...'
            });
